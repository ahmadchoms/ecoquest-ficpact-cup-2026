    ...
    <section className="bg-white py-[100px]">
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="text-center mb-14">
          <EcoBadge variant="mint" className="mb-4">
            Fitur
          </EcoBadge>
          ...
          <p className="text-[17px] text-[#666] mt-3">
            Teknologi modern untuk pengalaman belajar yang imersif.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((feat, i) => (
            ...
            >
              <div className="w-[52px] h-[52px] rounded-xl bg-white border-2 border-black flex items-center justify-center mb-[18px]">
                {iconMap[feat.iconName]}
              </div>
              <h3 className="font-display font-extrabold text-lg text-black mb-2.5">
                {feat.title}
              </h3>
              <p className="font-body text-sm text-[#444] leading-[1.65]">
                {feat.desc}
              </p>
            </motion.div>
          ))}
