            ...
            <div className="max-w-7xl mx-auto px-6 pt-[60px]">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <motion.div variants={staggerContainer()} initial="hidden" animate="visible">
                        ...
                        >
                            Bergabunglah dalam misi menyelamatkan bumi. Pelajari, mainkan, dan buat dampak nyata dari rumahmu.
                        </motion.p>

                        <motion.div variants={fadeIn("up", 0.4)} className="flex flex-wrap gap-4">
                            <Link to="/map" className="group">
                                <EcoButton variant="primary" size="lg">
                                    Mulai Sekarang <ArrowRight size={18} className="group-hover:translate-x-1.5 transition-all" />
                                </EcoButton>
                            </Link>
                            {!firstVisit && (
                                <Link to="/dashboard">
                        ...
                        >
                            {["🌿 Gratis Selamanya", "🏆 5000+ Pemain", "🗺️ 34 Provinsi"].map(t => (
                    ...
                    >
                        <div
                            className="border-3 border-black rounded-[32px] shadow-hard-xl bg-[#0b1a2e] overflow-hidden aspect-square w-full"
                        >
                            <ErrorBoundary fallback={<div className="w-full h-full bg-green rounded-3xl flex items-center justify-center"><IlluGlobe className="w-[200px] h-[200px] text-black" /></div>}>
                        ...
                        <div
                            className="absolute -bottom-5 -left-6 bg-yellow border-3 border-black rounded-2xl px-5 py-3 font-display font-extrabold text-sm flex items-center gap-2 shadow-hard"
                        >
