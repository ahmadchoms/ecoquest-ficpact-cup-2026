        ...
        <section className="bg-white py-[100px] font-body">
            <div className="max-w-[1100px] mx-auto px-6">
                ...
                <div className="text-center mb-[72px]">
                    <EcoBadge variant="green" className="mb-4">Cara Kerja</EcoBadge>
                    <h2 className="font-display font-extrabold text-[clamp(36px,5vw,60px)] text-black leading-[1.1]">
                        Cara Kerja EcoQuest
                    </h2>
                    <p className="text-[17px] text-[#666] mt-3">Tiga langkah mudah menjadi pahlawan lingkungan.</p>
                </div>
            ...
            `}>
                        ...
                        <div className={`${flip ? 'md:order-1' : 'md:order-2'}`}>
                            <div className="flex items-center gap-3.5 mb-5">
                                <NumBadge n={num} />
                                <span className="font-body text-[13px] font-bold text-[#999] uppercase tracking-widest">Step {num}</span>
                            </div>
