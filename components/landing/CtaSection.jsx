            ...
            <div className="max-w-[900px] mx-auto px-6 text-center">
                ...
                >
                    <div className="flex justify-center gap-6 mb-10">
                        ...
                        <IlluTrophy className="w-20 h-20 animate-float" style={{ animationDelay: '1s' }} />
                    </div>
                    ...
                    <p className="font-body text-lg text-[#444] max-w-[540px] mx-auto mb-10 leading-[1.75]">
                        Jangan hanya membaca tentang perubahan iklim. Bergabunglah dengan EcoQuest dan jadilah bagian dari solusi hari ini.
                    </p>

                    <Link to="/map" className="inline-block group">
                        <EcoButton variant="secondary" size="lg" className="px-9 py-4 text-[17px]">
                            Mulai Petualangan Gratis <ArrowRight size={20} className="group-hover:translate-x-2 transition-all" />
                        </EcoButton>
                    </Link>
                </motion.div>
            </div>
